...
« N.B. Le cas $p = m$ peut être omis, car
$H^{m}(X^{r}, \mathcal{O}(-n)) = 0$ pour $n$ grand »}
...
\note{feuillet dactylographié, en tête « -- III-18 -- »,
...
le tapuscrit ayant écrit « si une section »}
...
\note{second feuillet dactylographié, en tête « -- III-5 -- »,
...
elle corrige « si $X$ est noethérien » en
« si $X$ est un préschéma noethérien », et un
