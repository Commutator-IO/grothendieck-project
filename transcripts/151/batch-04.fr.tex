...
\[
  ...
  \end{cases}
\]
— car sinon on aurait $X_i^{*} = \emptyset$ (justifie …) Il n'y a donc pas
...
plein) \struck{explicités} et indiqué\supplied{s} dans $(17)$. Alors $X$ s'identifie
...
tubulaires d\supplied{e} une telle partie dans une entière. Notons
...
\marginal{seulement} (des) équivalences d'homotopie …
