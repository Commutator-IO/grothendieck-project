...
\page{41}
… uns « évidents », qui ici dit que la donnée d'une gerbe $\mathcal{G}_X$
...
\uncertain{peu} vraisemblable — puisque \ill\ « $k > V$ » …\ et \ill\
devrait \ill}
...
…). Quand $j$ n'est pas un successeur de $i$, alors $C_{ij}$ sera encore
...
qu'il faudrait dégager …) : un fibré loc. trivial de base $X_i^{*}$ —
