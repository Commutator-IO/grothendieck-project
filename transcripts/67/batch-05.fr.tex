...
%           elliptic curves are the torsors E^!_a, which give the
%           non-orientable conformal surfaces of genus 1 with boundary.
...
\uncertain{réelle} sur un corps \ill{} dans le\add{quel} \ill{} soit
...
\add{$k$-}modules pour lesquels $2\,\mathrm{id}_{P}$ et $2\,\mathrm{id}_{Q}$
...
\uncertain{à} bord non orientables de genre 1. La suite exacte de
