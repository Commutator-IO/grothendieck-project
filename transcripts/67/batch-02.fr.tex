...
% Revised 2026-09-23 (Opus 5.5), against the facsimile: page 21 is no longer
% said to be paginated « 5 » — at the top centre, where page 20 carries his
% « 6 », the carbon shows only a mark too faint to read; its text is that of
% sheet 6. The run's end on page 40 now points to its continuation, page 41
% (his circled « 16 », batch 3).
%
% What the batch is.
%   21     A second, fainter copy (carbon) of the last typed leaf of the
%          letter to Lipman Bers (batch 1, page 20, his sheet 6), with the
%          same two handwritten insertions. At the top centre, where the top
%          copy carries his « 6 », only a faint mark shows, which cannot be
%          read. Transcribed, since it carries the mathematics; the letter
...
%          stops mid-sentence at the foot of page 40 (« la deuxième »); it
%          continues on page 41, his circled « 16 », in batch 3, and goes on
%          to his « 18 » on page 43.
%
...
porte le « 6 » de sa main, on ne voit qu'une trace trop pâle pour être lue}
...
\note{la page s'arrête au milieu de la phrase, qui se poursuit en haut de la
page 41 (lot 3), son feuillet 16}
