...
est \add{réunion d'}une courbe de Jordan \struck{rectifiable. Alors il
...
$(D'_i, D''_i)$ mutuell\add{emen}t \uncertain{polaires}, il y a un argument
...
\]
\marginal{(*)} celui du deuxième membre étant \ill{} complété\add{s}, un
