...
%  - pp. 26-40 are his sheets 1-15. P. 44 (circled number read « 17 ») belongs
%    between p. 26 and p. 27: it carries Corollaire 3 after the Cor. 1-2 of
%    p. 26 and ends « On trouve donc de plus », which p. 27 continues « les
%    surfaces suivantes » (p. 27 is noted as lacking its lead-in). P. 45
%    (read « 21 ») belongs between p. 27 and p. 28: it ends « La constante
%    multiplicative », and p. 28 opens « déterminée par la condition que
%    l'aire totale de X soit = 1 » (p. 28 is noted as lacking the start of
%    case 2). Pp. 41-43 (read « 10 », « 11 », « 12 ») continue p. 40, whose
%    last sentence (« la deuxième ») runs on into p. 41. The circled numbers
%    as read do not fit the series 1-15; the text does. Reported, not
%    corrected: the transcription governs the readings.
%  - pp. 53-81 are one run, his sheets 1-15 again (a different series), dated
%    11.1.84 (p. 53), 12.1. (margin p. 60 and p. 69), 13.1. (p. 73). P. 81
%    finishes p. 80's sentence.
%
...
deux suites de feuillets, de 1 à 15 chaque fois : on les cite comme « son
feuillet $n$ ».
...
\emph{L'ordre des feuillets sur les métriques canoniques.} Les pages 26 à 40
sont ses feuillets 1 à 15. Trois autres feuillets, que la transcription donne
aux pages 41 à 45 avec des numéros cerclés lus 10, 11, 12, 17 et 21, ne
prolongent pas cette série par leurs numéros ; ils la complètent par leur
texte. La page 44 s'insère entre les pages 26 et 27 : elle porte un
...
la condition que l'aire totale de $X$ soit $= 1$ ». Les pages 41 à 43 suivent
la page 40, dont la dernière phrase se poursuit en haut de la page 41. On lit
donc : 26, 44, 27, 45, 28 à 40, 41 à 43. Ces raccords sont les nôtres ; ils
reposent sur le texte, non sur les numéros.
...
d'un manuscrit de Tate de 1959, diffusé puis publié par Roquette en 1970, et
le quotient $\mathbb{C}^{*}/q^{\mathbb{Z}}$ remonte à Jacobi. La page ne cite
rien. Le lien avec les dégénérescences des pages 73 à 81 est le nôtre.}
...
26, 44, 27, 45, 28 à 40, puis 41 à 43. Deux feuillets volants les précèdent.
...
« Chirurgie conforme ». La suite est numérotée par lui de 1 à 15 et va
jusqu'à la page 81.
...
page 27.\footnote{La page biffe « sans » et écrit au-dessus un mot lu
« à » sous réserve. Mais un torseur sous $E_a$ est trivial dès qu'il a un
