...
% Revised 2026-09-23 (Opus 5.5): the letter's pagination re-read on the
% facsimile — pp. 15-20 carry his handwritten 1 to 6, top centre; the note
% opening the letter now says so and points to the carbon of sheet 6 (p. 21,
% batch 2), whose own number is too faint to read.
%
% What the batch is.
...
\note{lettre dactylographiée, en anglais, de six pages numérotées à la main
