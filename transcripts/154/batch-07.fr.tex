...
les repères de la surface correspondent aux p.r.\ \add{$D$ orientées} qui \add{sont de spécialité} \struck{\ill{}} $\geqslant 2$, \emph{munies} de plus d'un sommet\add{$s$} et d'une orientation en ce sommet i.e.\ d'une rive du complémentaire $D \setminus \lbrace s \rbrace$
