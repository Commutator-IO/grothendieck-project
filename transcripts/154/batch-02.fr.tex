...
\page{38}
qui applique \supplied{\uncertain{l'}}extrémité de l'un des \struck{\ill{}} arcs, sur l'unique extrémité de l'autre qui appartienne à la « même » \struck{pseudo-droite} corde i.e.\ pseudo-droite, donc en \struck{\ill{}} \add{\ill{}} \uncertain{intervertissant} les extrémités, donnant \uncertain{lieu} à la \struck{figure} figure ci-contre.
