...
composantes irréductibles $X_i$ soi\supplied{en}t isomorphes (avec la structure
...
One final remark: I needed here the results on tamely ramified covering\supplied{s}
