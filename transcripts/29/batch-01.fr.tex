...
\underline{n}$, auquel cas…etc…}, it seems to me that this should be
…\emph{sauf si $\underline{n}' = \underline{m}\cdot\underline{n}$, auquel
cas…} and where $\underline{m} = (m_i)_{i \in I}$ is a set of positive
integers.
...
to be proven the following: … Alraedy when $D=0$, the proof here would
