...
écrit « Prop.\ 5 … » et rien après. La page 206 écrit « Prouvons que
...
nous aurons à utiliser, les foncteurs de transition …\ sont pleinement
fidèles », puis « Nous supposerons que … ». Ce sont bien deux conditions
...
$\operatorname{supp} D$ … ». C'est-à-dire : dans ce cas particulier, et
...
\subsection*{« On soit infailliblement conduit … »}
...
multigaloisienne … ». Sa définition axiomatique est aux pages 208 à 216 du
...
« on recule devant la tâche … , jetant provisoirement un voile pudique sur
...
$s$ et de …\ étant un élément de structure artificiel. » Suit la
...
\emph{nécessaire} », et « cela doit marcher … ».
...
récurrence.\footnote{C'est la fin de la suite paginée I à VI, et la page 57 est la plus abîmée de la suite ; la marge porte « finir si le … », et la remarque
...
La restriction à $\pi'_{1}$ est signalée sur la page même : « mais elles …\
...
\begin{itemize}
  ...
  \item \emph{La normalité est un artifice.} « Normality-assumption unnatural
    (formal normality, as formal schemes…) ». C'est le même reproche qu'il
...
…\ que nous appellerons l'\emph{extension de Raynaud} associée à $A$ », et
...
(« on voit que le noyau …\ est toujours uniquement divisible par $n$ »)
...
théorème de …\ et unicité » --- confirme la lecture : c'est bien l'unicité
...
« Pb intér.\ pour l'affirmative […\ et $S' \to S$ fidèlement plat
quasi-compact] ».
...
décider de descente : le \emph{Van Kampen} …
\end{quote}
...
\item[\textbf{R4}] Pour $X \to Y$ dominant dans $R_{S}$, on veut que les
  ...
  sont localement finies ; R4 que …\ L'axiome sur le changement de base est
  trivial. »}
\end{itemize}
...
autre chose.\footnote{La page 196 porte « \textbf{Prop.\ 5} … » et
...
[caractéristiques] résiduelles des $D_{i}$ seulement … ». C'est-à-dire :
...
\item[\textbf{G5}] Soit $f : X \to Y$ avec $X$ et $Y$ connexes. Alors il existe
  un entier $N$ tel que, pour tout $Y' \to Y$ non vide, …\footnote{L'énoncé
...
factorise en le produit d'un épimorphisme et d'un monomorphisme …\ tout
