...
donc t\supplied{ou}te donnée de descente est une \uncertain{prolongation} et on
utilise le fait
\[
  \pi_0(K_{\ast}) = e
\]
...
\supplied{dé}cider \ill{} de descente : le \emph{Van Kampen}\,\ldots
...
peut vérifier un énoncé comme précéd\supplied{emmen}t, aux
