...
question peut aussi s'interpréter comme la classe des \supplied{sous-}groupes
...
donc que les \supplied{sous-}groupes d'inertie de $H$ en $y$ sont les conjugués des
images des \supplied{sous-}groupes d'inertie de $G$ en $x$.
