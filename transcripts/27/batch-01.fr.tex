...
\struck{\uncertain{on}} suppos\add{ons} \struck{encore} l'inégalité (2)
valable, et $G, V, W$ géométriquement irréductibles\add{,}
...
conjugué de $W$ par un élé\add{ment} de $G(k)$. De plus, pour un
...
Zariski\add{.} \add{On} not\add{era} que \struck{\ill{}} l'hypothèse que
