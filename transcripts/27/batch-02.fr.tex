...
\ldots\ ici que $\psi$ \emph{est birationnel}.
...
Lie d'\uncertain{aucun} sous-groupe lisse de $G$ \ldots
...
ss-groupe \uncertain{de} Cartan \ldots\note{un trait vertical dans la marge
...
\underline{Th} \quad Soit $G$ un préschéma en groupes \add{lisse} séparé de
...
\begin{itemize}
  ...
  \item[(ii)] \struck{Si $G$ est \underline{plat} sur $S$}, les fonctions
...
\underline{croissante} du groupe. Donc \ill{} \ill{} \uncertain{prouver}
[quitte à \uncertain{remplacer} $G$ par $\overline{G_1^{\circ}}$]
\struck{de \uncertain{remplacer} $G_1$ \ill{}} \ill{} \ill{} \ill{}
\underline{\uncertain{toujours}} $G$ plat sur $S$, et de plus

\page{32}

(quitte à faire une \underline{extension} finie de $S$ et
...
elle se réduit \underline{ici} (en effet) à l'égalité $d = d'$.
L'inégalité $\rho_{\mathrm{aff}} \geqslant \rho'_{\mathrm{aff}}$
\underline{équivaut alors} à $\rho_{\mathrm{ab}} \leqslant
...
\ldots\ \uncertain{est} une extension d'une V.A.\ $A_0$ par un groupe
...
\underline{Lemme} $C$ groupe nilpotent \uncertain{connexe} lisse sur corps
alg.\ clos $k$. Alors
\[
...
\struck{\underline{Corollaire} Soit $G$ lisse sur $S$, et supposons que}
...
\uncertain{prolongent} de \underline{façon} \underline{unique} en des
...
\underline{commutativité}, qui implique d'ailleurs $\rho_{\mathrm{n}} =
...
\underline{unipotent}, \underline{il en est de même de} $G_0$.
...
\underline{affine}, $G_0$ \uncertain{est} \underline{affine}.
...
\uncertain{priori} \ldots). \struck{\uncertain{Considérons} \ill{} $G$ et
la \ill{} \ill{}} \ill{} \ill{} \uncertain{supposer} \underline{le tore
...
\underline{un} \underline{\uncertain{groupe} réductif} \ill{}
\underline{\uncertain{spécialise} en un réductif}\note{chiffres
entourés}
