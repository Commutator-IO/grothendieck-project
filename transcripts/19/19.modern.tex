...
… de la catégorie Eilenberg--Moore ». C'est la seule mention du nom dans
...
\textbf{Une convention, à lire avant les formules.} Le manuscrit
...
ligne porte « (Pour Mlle … ?) ». Quatre feuillets au
...
\textbf{Rappel des définitions.} Soit $p : E \to B$ un foncteur. Une
...
\textbf{Une notation à retenir.} Sur ces pages, et contrairement à
...
$E_{b}$.\footnote{La page écrit « en prenant pour la … $E_{b}$ des gén.\
