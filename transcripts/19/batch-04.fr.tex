...
\textbf{NB} Les opérations \uncertain{de dégén\supplied{érescence}} n'utilisent que
$\beta$, \ill{} $\lambda$.
...
\ill{} des relations dans la définition de la transporta\supplied{bilité}.
...
\page{76}
Titre porté sur la chemise : « Morphismes et comor\supplied{phismes} — Liste
Problèmes ».
...
\item[7)] Les \struck{morphismes} de $\underline{U}$-topos forment une
      $U$-cat\supplied{égorie} \ill{} (i.e.\ les $\mathrm{Hom}$ sont « petits »).
