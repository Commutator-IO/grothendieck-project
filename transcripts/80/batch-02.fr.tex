...
\page{36}
squelette de dimension $1$ » ($1$-complexe combinatoire, muni des systèmes des trois \struck{ps.}\ sous-$1$-complexes $D_i$. \struck{\ill{}} Donc $K$ est la réunion des sous-$1$-complexes $D_i$, qui sont des bigônes, \add{chacun} défini\add{s} par \add{$S_i$} \add{\uncertain{un}} ens.\ de \add{deux} sommets et d'arêtes \add{$A_i$} \struck{\ill{}} :
