...
% sources.
% Revised 2026-09-23 (Opus 5.5): (1) the résumé said « quatre pages » on go;
% the run is pages 29-33, five pages all in his hand (checked on the
% facsimile), and now says « cinq », as section IV already did. (2) No order
% in time between the pages and the literature, and no claim about what he
% knew: the résumé's « une quarantaine d'années plus tard » and the footnote
% on species and FI-modules (« postérieurs … ne pouvait pas les connaître »)
% now say only that the pages cite neither; likewise Mac Lane's pentagon (no
% « antérieur de dix ans »), Tall-Wraith (no « qu'il pouvait connaître »),
% folder 135 (the inventory's « [vers 1974] » instead of « daté des mêmes
% années ») and folder 2 (« aussi posés », not « déjà posés »). (3) Pages 47
% and 49 are no longer called versos of 46 and 48: the spine section, its
% footnote, section VII and the résumé say what the facsimile shows (two
% notices of 19 and 5 June 1975, skipped by his pagination, a mirrored hole
% on 48/49) and that it does not establish which leaf backs which, so the
% notices date nothing he wrote unless it does. The offprint title
% « Skolem-Nother » checked on the facsimile: printed so, kept.
%
...
% Pages 47 and 49 are typed USTL « avis de soutenance » addressed to him,
% dated 19 June 1975 (47) and 5 June 1975 (49). Whether they are the backs of
% 46 and 48 the facsimile does not settle (batch-03's header gives what it
% shows); the reading dates nothing of his by them. The unity of the folder is the
...
ensembles munis de symétries et cinq pages sur le jeu de go. On les lit ici
...
définis sur les ensembles finis et leurs injections — ceux qu'on étudie
aujourd'hui sous les noms d'espèces de structures et de FI-modules, que ces
pages ne citent pas —, puis la version linéaire : la puissance
...
l'inventaire. Les seules dates imprimées du dossier sont celles des tirés à
part, de 1974, et de deux avis administratifs de juin 1975 rangés parmi les
dernières pages ; que l'un d'eux porte au dos une page de sa main, et date
ainsi ce qu'il y a écrit, le fac-similé ne l'établit pas.
...
deux avis de soutenance dactylographiés de l'administration de l'université,
datés du 19 juin 1975 et du 5 juin 1975, qui lui sont adressés ; sa
pagination, 2, 3 et 4 aux pages 46, 48 et 50, les
saute\footnote{Ils ne sont pas de sa main et ne sont pas transcrits. Qu'ils
soient le dos des pages 46 et 48 n'est pas établi : une pagination qui les
saute s'accorde aussi bien avec des feuillets distincts rangés entre ses
pages. Le fac-similé montre, au bord supérieur, un petit trou de même forme
près du coin droit de la page 48 et près du coin gauche de la page 49, en
positions symétriques ; cela s'accorde avec une seule feuille vue de ses
deux côtés, mais aussi avec deux feuilles percées ensemble. Rien de tel ne
relie les pages 46 et 47. Si la page 49 est le dos de la page 48, sa page 3
est écrite au dos d'un avis daté du 5 juin 1975 ; sinon, ces avis ne datent
...
que l'inventaire date « [vers 1974] ».
...
« Natural associativity and commutativity », 1963 ; la page ne le cite
pas.}. Le même schéma — deux
...
deux noms ne sont pas ceux de la page, qui ne cite ni Joyal ni Church,
Ellenberg et Farb : les espèces de structures sont de 1981, les FI-modules
de 2015. L'identification est de nous.}.
...
sont de Tall et Wraith (1970), le nom de « pléthorie » de Borger et Wieland
(2005) ; la page ne cite ni les uns ni les autres.}.
...
tensorielles d'un module sur un topos annelé sont aussi posés\footnote{Le
...
paginées par lui de 1 à 7 ; les pages 47 et 49, deux avis administratifs
dactylographiés, ne sont pas de sa main. Malgré le titre, rien n'y est propre aux groupes formels :
