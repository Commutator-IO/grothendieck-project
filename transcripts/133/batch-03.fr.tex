...
% Revised 2026-09-23 (Opus 5.5): header only — the claim that pages 47 and 49
% are the backs of 46 and 48 « since his own pagination runs straight across
% them » is withdrawn; the paragraph on pages 47 and 49 below now separates
% what the facsimile shows (dates of both notices, labels, crease, no
% show-through, the mirrored hole on 48/49) from what is inferred. Nothing in
% the transcription changed.
%
...
% administration, nothing in his hand.
%
% Pages 47 and 49 — what the facsimile shows, and what it does not.
% Observed: both are « avis de soutenance d'une thèse de doctorat de
% spécialité », dated « Montpellier, le 19 juin 1975 » (p. 47) and « le 5 Juin
% 1975 » (p. 49), each with a pasted label « MR LE PROFESSEUR GROTHENDIECK A.
% / MATHEMATIQUES 5-856 » (upside down on p. 49), each with its own archivists'
% pencil number. His pagination runs 2 (p. 46), 3 (p. 48), 4 (p. 50) and
% skips them. Leaves 45 to 50 all carry a horizontal crease at about half
% height, so the crease links none of them to another in particular. No
% show-through is visible in either direction on the 250 ppi scans, even
% under strong contrast. At the top edge, p. 48 has a small torn hole near
% its right corner and p. 49 a hole of the same shape, at the same distance
% from the edge, near its left corner: mirror positions. Nothing comparable
% pairs p. 46 with p. 47.
% Inferred, and no more than that: the mirrored hole favours p. 49 being the
% back of the sheet that carries p. 48, but a hole pierced through two
% separate sheets lying face to face would look the same. For p. 47 the
% facsimile gives nothing either way. The skipped page numbers do not decide
% it: a separate sheet filed between his pages would be skipped as well. Only
% if p. 49 is the back of p. 48 does his p. 3 sit on the back of a notice
% dated 5 June 1975, which would then bound its writing from below; if it is a
% separate sheet, the notice dates nothing he wrote. The same holds for p. 47
% (19 June 1975) and his p. 2. No offprint (« tiré à part ») falls in this batch, so the
