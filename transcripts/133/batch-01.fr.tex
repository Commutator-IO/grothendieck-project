...
% Revised 2026-09-23 (Opus 5.5): the first offprint's title re-checked on the
% facsimile (page 10, 400 dpi): it is printed « Skolem-Nother », in the title
% and again in the abstract; kept as printed, flagged « sic » in the note
% before page 17 that quotes it. Nothing else changed.
%
...
%     graduées sur un anneau semi-local » (« Nother » sic, as printed),
%     C. R. Acad. Sc. Paris, t. 279
...
\note{sic : « Skolem-Nother », pour Skolem-Noether, est la graphie imprimée
du premier tiré à part, au titre comme au résumé (feuillet 10).}
