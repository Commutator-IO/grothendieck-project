...
\item[2)] Contr\supplied{a}ctors, morphisms of such
...
After a minute\supplied{'}s thought, I feel very silly to find out that point a) is
about trivial --- that I have been dragging for months the notion of a
total\supplied{ly} $W$-aspheric category $A$, without taking the trouble to sit down
...
\emph{NB.} Si $A \xrightarrow{f} B$ asphérique, alors
...
$M \to \hat{M_{as}}$ (i.e.), il faut que $M_{as}$ est \emph{génératrice}.
