...
\item[K --- XVII] Pinceaux de Lefschetz : \emph{existence} $/\!/$
\emph{étude cohomologique}
...
$e_{E}$ de $e_{p}(E)$ qui est \emph{centrale}, i.e.\ qui satisfait à la
...
\marginal{NB VI, VII, VIII, XXII …\ tout ce qui est d'un usage de
monodromie, et \ill}
