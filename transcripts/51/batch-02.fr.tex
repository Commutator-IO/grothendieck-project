...
%
% Both pages are transcribed; nothing is absent. Page 21 carries « 11 » in
% his hand, top right (recorded once in a \note); it is the only number of
% his in the folder — batch 1 has none — and it fits no run the folder
% shows. Page 22 is a fresh sheet under a heading of his own, « Schémas
% abéliens sur un S régulier », which becomes the second \section; the
% first \section heading is bracketed, being ours. The folder title
% « " Bonne réduction " (Shimura-Koizumi) » is not bracketed in the inventory
% and copies the words on the folder's cover sheet (batch 1, p. 1).
%
% What the batch is.
...
\page{21}
\note{« 11 », de sa main, en haut à droite ; aucun autre feuillet du
dossier ne porte de numéro de sa main.}
