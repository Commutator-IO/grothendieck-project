...
\begin{itemize}
  ...
  \item \struck{N° 5} --- \struck{Premières propriétés des réarr\supplied{angements} \ill{} d'un \ill{}}
...
\note{Titre de sa main, page 18 : « 4 Mesures spectrales et réarr\supplied{angements} \uncertain{spectraux} d'opérateurs. » C'est le « N° 4 » du plan de la page 2. Dans ces trois pages, une main postérieure à l'encre noire corrige $\Omega$ en $M$ à chaque occurrence ; on transcrit $M$ et on signale la première correction.}
