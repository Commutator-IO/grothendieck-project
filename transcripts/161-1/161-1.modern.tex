...
% pages by a human. It predates the modernisation skill and its pin to Opus 5,
% which is why the model named here is not that one.
%
% Scope: a SINGLE document for the whole folder, the convention 161-3's reading
% established. The shelfmark holds one batch, so pages 1-19 are the folder
...
\foldertitle{Catégories : notes manuscrites (s.d.) — lecture modernisée du dossier entier}
