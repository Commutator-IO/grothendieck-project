% Transcription — fonds Alexandre Grothendieck, cote 161-1, lot 1 (feuillets 1-19).
% Établie sur le fac-similé archives/batches/161-1/batch-01.pdf (miroir de
% https://grothendieck.umontpellier.fr/161-1.pdf), selon la skill
% transcribe-grothendieck. Feuillets 2, 8, 14 : pages blanches (versos) —
% absents. Feuillet 16 : verso réutilisé, notes au crayon tête-bêche sur un
% tout autre sujet (périodes p-adiques) — absent, comme il se doit. Feuillet
% 18 : verso blanc portant trois flèches griffonnées sans étiquettes — absent.
...
\section*{Foncteurs adjoints (feuillets 3 à 7)}
...
obliques, occupe le milieu du feuillet}
...
que $\alpha'$ inverse, comme l'explicite le feuillet suivant}
...
\[
(u : X \to Y) \in \Sigma
\iff \alpha'(u) \ \text{\struck{un isom}}
\iff \mathrm{Hom}_{E_1}(\alpha'(Y), Z_1) \simeq
     \mathrm{Hom}_{E_1}(\alpha'(X), Z_1)
\ \ \text{pour } \forall\, Z_1 \in \mathrm{Ob}\,E_1
\]
\note{« un isom » est biffé et remplacé en interligne par
« $\alpha'(X) \simeq \alpha'(Y)$ »}
\[
...
\section*{Produit tensoriel et familles finies (feuillets 9 à 12)}
...
l'automorphisme d'ordre 2 de $L \otimes L$ ; elle se poursuit au feuillet
12 — le feuillet 11 porte une construction intercalée}
...
\section*{Théories et constructions (feuillet 13)}

\leaf{13}
\note{page numérotée « 2 » de la main de l'auteur — la page 1 n'est pas
dans la chemise ; le feuillet entier est barré d'un long trait oblique}
...
\section*{Prolongement aux préfaisceaux et exactitude (feuillet 15)}
...
\section*{Prolongement le long d'une sous-catégorie génératrice (feuillets 17 et 19)}
