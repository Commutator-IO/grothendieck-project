...
On dit que $L$ est \emph{lisse} si, pour tout $a \to b$ dans $A$,
\[
...
On dit que $L$ est \emph{négligeable} si $L^{b}$ est \ill
...
\item[C)] Objets \emph{lisses} de $\hat{A}_{k}$ (plus général) :
