...
géométrique) \uncertain{un} composa\add{nt} \struck{commun $\mathrm{Coim}\,
...
cette nature soit prouvé, même si $X = \mathbf{P}^{2}$ \add{(}i.e.\ pour des courbes planes \add{$Y$} de grand degré\add{)}.
