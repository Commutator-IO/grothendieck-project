...
\textcircled{1} suite exacte pour $\underline{t}_{\tilde G}$ et
...
\textcircled{2} \struck{Donc} La suite exacte \ill{} \ill{},
\[
\begin{aligned}
...
\textcircled{3} $F_0$ et \struck{$V$} $V_0$ \ill{} sur $H(G)$
...
\textcircled{4} Le \uncertain{comparaison} \struck{\ill{}}
