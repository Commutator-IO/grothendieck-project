...
\supplied{$p$-}groupes de Barsotti-Tate sur $K$, notés $M =
...
l'instant seulement dans le cas d'\supplied{in}égales caractéristiques), d'un
...
envisagée comme fonction sur le \supplied{sous-}groupe d'inertie (infini) de
