...
D_*(\Delta_0)$ (plus général\add{ement} $D_n = D_*(\Delta_n)$ est l'ens
...
applications \emph{str\add{ictemen}t croissantes}) i.e.\ définissent un
foncteur
\[
...
\add{$\mathrm{Dr}(N)$} des parties finies tot\add{alemen}t ordonnées de
...
\]
est \add{$(i-1)$-}admissible (NB le cas $i = 1$ est trivial), et les
