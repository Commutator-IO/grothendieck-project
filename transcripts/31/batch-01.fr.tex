...
\struck{de} à engendrement fini i.e.\ si $H$ est de type fini\supplied{, du
...
s'ensuit que $Q$ est \struck{somme de} \supplied{réunion de sous-}préschémas à la
...
\textbf{Corollaire 5.14.} Soi\supplied{ent} $S$ un préschéma localement
