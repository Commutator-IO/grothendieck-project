...
L'idée qui règle cela est le cœur du dossier, et elle est jolie. Le lieu où
...
page 1, qui porte seulement « $p_{xy}$ est l'image … de
...
$(O_x)$ … tel que pour $x \leq y$, $O_x \to O_y$ induise un isomorphisme
...
\begin{quote}
$(\mathrm{H})$ : pour tout $x \in X$, il existe un ouvert non vide $U$ de
