...
\begin{itemize}
  ...
  \item cas différentiable (à \struck{pts \ill{}} bord lisse\supplied{s} ?)
...
\begin{itemize}
  \item[(0°)] Somme directe\supplied{s}.
  \item[1°)] \emph{gommage} \add{total} \struck{\ill{}} des repères se
    trouvant sur un \add{\uncertain{les}} cercle\supplied{s} de recollement, ou
