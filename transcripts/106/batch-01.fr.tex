...
% page 12, two small trial figures in the bottom margin; page 14, a block of
% amalgamated-sum squares leading from x v x to y' v y'', of the shape of the
% top arrow of page 15's diagram. Pages 4, 6, 8, 10 and 16 carry
...
% — page 12: the note said the listing's printed dates (24 and 25 AUG 82, pages
%   12 and 14) « datent le dossier »; they date the printing of the listing,
%   not the notebook leaves. Rephrased so.
% — page 14 and this header: « le bloc ... que la page 15 met en œuvre » /
%   « that page 15 uses » implied an order the leaves do not date; the block
%   is now described by what it shows and its likeness to page 15's diagram.
% — page 15 checked on the facsimile: the last factor of
%   [f_0, i] = [id, i] o (f, id) is indeed an unsubscripted f; unchanged.
...
feuillet ; elle date l'impression du listing, non les feuillets de bloc}
...
porte, de sa main, un bloc de sommes amalgamées qui mène de $x \vee x$ à
$y' \vee y''$, de la forme de la flèche du haut du diagramme de la page 15.
