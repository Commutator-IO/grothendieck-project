...
Prenant les \ill{} des deux membres, ce\supplied{tte} formule se réduit
...
Ce\supplied{ci} redonne bien \add{(}\ill{}\add{)} la formule de Hirzebruch pour le
...
pas contenu dans la formule de Hirzebruch proprement dite. Ce\supplied{ci}
