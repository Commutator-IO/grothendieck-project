...
régulière\supplied{s} dans $V\otimes\mathbf{C}$ telle qu'il existe un élé-
...
éléments « réguliers \supplied{semi-}simples » i.e.\ de nullité minimum
...
« réguliers \supplied{semi-}simples ». Il est stable sous $W$.
...
paraboliques de \supplied{Dynkin-}Kostant) l'existence d'un parabolique de cette
