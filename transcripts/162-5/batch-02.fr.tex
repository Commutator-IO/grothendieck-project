...
\uncertain{uniques)} en une \struck{\ill{}} \add{anti}dérivation d'Algèbre
...
en dim $\geq 1$ »). Pour la notion grossière (Gr ou Grab) l'idée de ma
...
dimensions $\geq 2$.
\note{les deux signes $\geq$ sont repassés à l'encre sur un signe frappé ;
le premier chiffre, « 1 », est lui aussi retouché}
...
catégories équivalentes par le foncteur espace des lacets\add{ ?}).
