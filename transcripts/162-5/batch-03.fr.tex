...
%              absent. The typescript runs on past page 60 into batch 4.
%
...
% begun on page 57 continues into batch 4.
%
...
Pour trouver une catégorie universelle, on associe à toute $X$ \add{$S(X)$}
l'ensemble des sous-variétés \struck{$S(X)$} de $X$, modulo équivalence
