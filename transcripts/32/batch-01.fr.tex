...
\underline{H}^{i\add{+2(d'-d)}}(F_Y)(d'-d)\,\struck{[2(d'-d)]} ,
\]
de faisceaux sur $Y$, déduit\add{s} de (4.2.1) en appliquant
$\underline{H}^i$, ou
...
qu'il ne sera pas possible de donner un formulaire qui donne\add{rait,}
...
recommandé\add{,} parmi les variantes possibles).
...
un homomorphisme\add{,} fonctoriel en $G$\add{,} $H^{*}(X, G_X) \to
