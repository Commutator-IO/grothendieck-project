...
catégories »
\note{les quadrants de l'original sont marqués $\wedge\wedge$, $\wedge\vee$,
$\vee\vee$, $\vee\wedge$, et les arcs extérieurs $(\widehat{A}\to)$,
$(\widehat{B}\to)$, $(A^{\vee}\to)$, $(B^{\vee}\to)$ ; les deux nœuds de
gauche, en partie masqués par une déchirure, sont de lecture incertaine}
