...
\begin{itemize}
  \item[g$'$)] \struck{Idem} \uncertain{Analogue} à g), mais avec un « champ de
    ...
    \]
    La solution $x = \varphi(t, x_0)$ correspond\add{ant} : un
...
Soit $Z$ \add{un $A$-}schéma formel \uncertain{(lisse)} de dim.\ $q$,
...
En effet, considérons la \struck{multi\ill{}} \add{l'}automorphisme
\[
