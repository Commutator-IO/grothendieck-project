...
% Revised 2026-09-23 (Opus 5.5): removed "well before the Esquisse" from the
% note on pp. 24-30 below — no leaf carries a date, and the edition does not
% infer one.
%
...
% ν_λ punctures) — the "graphes" of the folder title. Page 22 has nothing
% to do with the rest of the batch. The dating line is the inventory's
% own, for the shelfmark and its group.
