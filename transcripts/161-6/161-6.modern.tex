...
%      pp. 16-19 (draft of pp. 3-4, Gamma' = A_5 via five triples, the coset
...
% Question (answered by the literature, and pursued in 161-4); p. 29 the
...
arc-transitif, de frame et de locale. Grothendieck lui-même reviendra aux
graphes sur les surfaces et à l'icosaèdre, sous le nom de « cartes » et de
« dessins d'enfants », dans l'\emph{Esquisse d'un programme} de 1984 ; c'est
un contexte postérieur, que ces pages ne citent pas.
...
\begin{enumerate}
  ...
  paradoxiques prêtées à Labarde », dont les deux mots décisifs sont d'une
  lecture incertaine.\footnote{Le dossier 162-1 du même fonds est un registre
  de prêts de la même période. Rien ne permet de rattacher cette mention à
  ce registre : la transcription de 162-1, parcourue pour ce travail, ne
  porte pas le nom lu ici, et les « formes paradoxiques » ne correspondent à
  ...
  \item \emph{Pages 15, 13 et pied de la page 12}, crayon, écrit tête-bêche
  par rapport à l'encre et barré : une démonstration sur des ensembles
  ordonnés (section V).
  \item \emph{Pages 16 à 19}, quatre feuillets d'un carnet à spirale :
  croquis, premier jet des pages 3 et 4, le groupe $\mathfrak{A}_5$
  (section II).
...
positive au besoin ». C'est le germe de la page 21, où l'icosaèdre est défini
...
\pagerange{17}{17}
\subsection*{Un premier jet des pages 3 et 4 (page 17)}

Avec d'autres lettres ($\rho_i$ pour $v_i$, $v'$ et $w'$ pour deux directions
tangentes faisant l'angle $2\pi/5$), la page 17 refait le calcul des côtés du
...
exacte : $\alpha(R) = \alpha(\alpha(Q)) = \alpha^{2}(Q)$. La note de la
transcription qui y voit une anomalie est à écarter.} Le groupe $G$ agit
...
juste est (1'). Ce sont des brouillons, que la mise au net corrige.}
...
d'axes.\footnote{On lit sans doute là une première idée de la définition,
où la constante serait un nombre d'or, que le calcul de la même page
remplace. Le petit diagramme du haut de la page, où un schéma
...
cette première idée ; $\mathbb{V}_5$ est le $\vartheta_5$ des pages 14 et 12,
...
Une suite au crayon, barrée d'un long trait, écrite tête-bêche par rapport à
l'encre, et qui se lit dans l'ordre : page 15, page 13, deux lignes au pied de
la page 12. Elle commence au milieu d'un raisonnement : la catégorie qu'elle
...
1968). Les termes \emph{ribbon graph} et \emph{fat graph} sont postérieurs,
des années 1980. Rien sur la page ne cite ces travaux. Grothendieck reviendra
à ces objets sous le nom de « cartes » dans l'\emph{Esquisse d'un programme}
(1984) ; c'est un contexte postérieur. Signalons enfin, sans pouvoir dire
