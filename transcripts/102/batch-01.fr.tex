...
Soit $S$ un site\add{ standard (i.e.\ à topologie moins fine que la
...
Pour que l'on ait $F \in \mathrm{Ob}\,\widetilde{S}_M$ il f\add{au}t
...
\item[3.] Morphismes formel\add{lemen}t lisses, formel\add{lemen}t nets,
formel\add{lemen}t étales, et variantes infinitésimales. Critères standard…
...
morphisme \struck{affine} formel\add{lemen}t lisse, non ram., étale ---
rel\add{ativemen}t lisse, rel\add{ativemen}t non ram., rel\add{ativemen}t étale
