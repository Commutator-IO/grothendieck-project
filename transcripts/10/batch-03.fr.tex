...
\struck{résulte des définitions (EGA II 1.7.1), compte tenu d'}\supplied{est un
...
\struck{Nous dirons qu'}\supplied{Notons qu'}un morphisme de $S$-foncteurs de
$G$ dans
...
\item[(iii)] On peut faire opérer $G$ fidèlement sur un \supplied{$k$-}schéma
quasi-affine.
...
Son enveloppe Karoubienne est une \supplied{$\otimes$-}catégorie abélienne, qui
