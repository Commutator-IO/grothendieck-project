...
\supplied{où $M$ n'}est pas supposé simple).
...
$\underline{\mathbb{Q}}_{p}$-\supplied{pro}algébrique du groupe discret
...
\supplied{[}Exercice amusant, que je n'ai pas fait : la structure additive de
...
Notons que le \supplied{$F$-iso}cristal de Tate $K(1)$ est de pente $-1$. Donc
