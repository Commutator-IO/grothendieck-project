...
\supplied{anti-}équivalente à la catégorie des groupes de B.T. sur $k$ mod.\ isogénie …) : le $F$-isocristal unité correspond au groupe de B.T.\ ind-étale $\underline{\mathbb{Q}}_{p}/\underline{\mathbb{Z}}_{p}$ sur $k$.
...
\supplied{$\mathcal{U}$-}topos. On le note $B_{\underline{G}}$ et on l'appelle
...
qui est un \supplied{quasi-}torseur à g.\ sous le sous-groupe $H'$ de $G'^{P}$
