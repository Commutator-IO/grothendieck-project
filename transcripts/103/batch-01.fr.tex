...
%
% Pages 8 to 15: a letter in Grothendieck's hand, « Lodève le 7.8.74 »,
...
%
% The date at the head of page 8 is faint: « 7.8.74 » is legible, and a
% short stroke before the 7 could be a 2 (27.8.74). Folder 134-1's copy was
% read « Lodève le 27. » with the rest lost; the two readings are noted, not
% reconciled. Running up the left margin of page 8, in a hand not
...
\emph{Cas particuliers} Dans l'exemple 1, on \add{doit} retrouve\add{r}
...
un $\otimes$-foncteur AUC) $C$ dans une \add{$\otimes$-}catégorie \add{AUC}
...
\struck{aux} \add{à l'}opération $\oplus$. Il y aurait lieu d'étudier
...
\section*{A.\ Grothendieck à P.\ Deligne, de Lodève, 7.8.74 (pages 8 à 15)}
...
est pâle : « 7.8.74 » se lit, et un court trait devant le 7 pourrait être
un 2 (27.8.74) ; l'exemplaire du dossier 134-1 a été lu « le 27. », le
reste perdu}
...
en » et « $L$ » sont insérés en interligne. Le dossier 134-1 a lu « s'obtient
en » comme biffé ; ici la phrase se lit d'un trait avec l'insertion. Devant
