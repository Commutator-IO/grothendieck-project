...
\ill{} \uncertain{peut} (\uncertain{lorsque} $X$ n'est pas f\supplied{ormellemen}t
...
\]
D'autre part l'hypothèse que $Y$ est f\supplied{ormellemen}t lisse sur $S$
...
$Y$ f\supplied{ormellemen}t lisse sur $S$, mais \struck{\ill{} localement}
