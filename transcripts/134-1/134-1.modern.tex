...
%    degree 2 the exact sequence (*). The correct statement is what appears
%    below, with the page's own in a footnote.
%
% 3. The direction of the triangle's arrows is what makes (*) come out rather
...
seul, placé exactement en degré $2$. On en tire une suite exacte courte $(*)$
...
qui pour moi ne fait guère de doute » --- et l'extension n'y est pas dite
scindée, mais « bien proche d'être splittée », ce qui est plus faible et
exact. Elle ne conclut pas :
...
La lettre est datée « Lodève le 27.8.74 ».\footnote{Sur cet exemplaire, une
photocopie, « 8.74 » est surmonté d'un trait que la première transcription
avait pris pour une rature ; c'est la barre du 7, et l'exemplaire de la même
lettre que conserve le dossier 103 montre ces chiffres nets, sans surcharge
(le « 2 » y est en revanche presque effacé). La date s'accorde avec ce que
dit ce dossier-là, où une lettre du 23 juin 1974 demande à Deligne, Giraud et
Verdier de siéger au jury de la thèse de Hoàng Xuân Sính, dont la présente
lettre fait un sujet de séminaire. Le dossier est intitulé « Lettres Breen 75,
76 » et l'inventaire date l'ensemble de 1974-1984. Les
...
$2$.\footnote{Page 5 : « $\sigma$ étant l'invariant qui s'obtient en associant à toute section
...
pas sur la page ; il est classique et donné ici pour que l'énoncé de $(*)$ ait
...
produit la suite $(*)$. Pris à l'envers, le même triangle donnerait la suite à
...
C'est $(T)$.\footnote{On notera au passage pourquoi $(*)$ n'est pas
...
\pagerange{4}{4}
\section*{La suite exacte $(*)$ (page 4)}
...
Grothendieck ajoute que $(*)$ « se construit en tout cas canoniquement à la
...
--- est précisément ce qui donne à $(*)$ son terme $\underline{\mathrm{Ext}}^2$
plutôt qu'un $\mathrm{Ext}^2$ global.}

\pagerange{5}{5}
\section*{Tout signe se réalise, et l'obstruction (page 5)}

L'exactitude de $(*)$ comme suite de faisceaux ne dit pas que ses sections se
...
Il en tire enfin une formulation prudente : la suite $(*)$ est « bien
...
affirmé qu'elle se scinde comme suite de faisceaux abéliens.\footnote{La page
dit « bien proche d'être splittée » ; le mot n'est pas barré, et c'est un mot
bref qui le suit, illisible, qui l'est. La prudence est justifiée : le
...
du terme médian $P(M,N)$ de $(*)$.\footnote{C'est le contenu du dossier 135 :
...
K-théorie ne fournit donc pas seulement une section de $(*)$ : elle fournit
...
\begin{quote}
Le triangle exact $(T)$ et la suite exacte $(*)$ sont-ils connus par les
...
connaissances en 1974 et que les seuls documents du dossier ne tranchent
