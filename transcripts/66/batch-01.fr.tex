...
tient)} : dualité (\emph{locale}, globale).
...
« continus » cohérents). Représentations d'Artin du point de vue cohérent…
...
\add{opérateurs} différentiels. Coefficients à connexion intégrable…\ Lien
avec « cristaux ».

\item[(9)] Dualité analytique…
...
fibres…). Structure des champs. champs représentables…
...
\item[17)] Séparation des \struck{foncteurs} : classes de correspondance…\
...
\struck{proalgébriques}, et de représentations de gerbes…\ (préliminaire
