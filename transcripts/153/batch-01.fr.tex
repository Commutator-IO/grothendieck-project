...
\item[b)] $T \circ F = F \circ T = F$ \qquad ainsi q\supplied{ue} $\varphi$ est
...
En effet, dans $K_0[X,Y] = K_0[X] \otimes_{k_0} K_0[Y]$, on a\supplied{ura}
\[
