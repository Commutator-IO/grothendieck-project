...
%          isomorphism, with two corollaries. The run continues into
%          batch 2, which opens on Corollaire 3; page 20 does NOT break
%          off mid-sentence — its last line is merely cut by the edge of
%          the scan, and the sentence it carries ends there. (An earlier
%          draft of this header said otherwise; corrected against the two
%          leaves on 2026-09-21.)
%
