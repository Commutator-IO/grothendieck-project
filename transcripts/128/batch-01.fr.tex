...
résultat par récurrence \ldots » est écrit à gauche des deux dernières
...
[d'où $E''$, $E'''$ \ldots\ formant un complexe
...
entièrement noirci de hachures. La parenthèse « tels que \ldots\ » est
...
également pour la donnée de descente sur $E'$ rel\add{a}t\add{ive à}
...
\ldots\ $\delta(b) \in ID$ ssi \struck{$b \in IB$} $\delta(b) = 0$, i.e.\
...
plats, et reste tel\add{le} par toute extension de la base
$X \to \mathrm{Spec}(A)$.
