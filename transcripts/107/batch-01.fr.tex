...
\emph{NB} On pense au cas où $B = \Delta$ p.\ ex.\ (cat.\ des
...
\]
(moyennant év\supplied{entuellemen}t des conditions de finitude) (alors que
...
\ill{} (\uncertain{quelconque}), le foncteur \emph{constant} sur $A$
