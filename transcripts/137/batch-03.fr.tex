...
\]
qui induit une équivalence de la catégorie des \supplied{$k$-}modules libres de t.f.\ avec elle-même.
...
\supplied{$k$-}catégorie \struck{\ill{}} des foncteurs « $\Sigma$-exacts »
...
\]
si $\mathcal{B}$ \struck{\ill{}} admet \supplied{$\Sigma$-}noyaux.
