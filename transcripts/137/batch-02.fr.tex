...
% Â_T ≅ (Â°_T')° (duality of free modules as the one-object case),
...
simpliciaux, ceux qui sont \supplied{str.\ $\partial$-}parfaits forment une sous-catégorie \emph{additive}
...
$F$ est un \supplied{$k$-}module à droite libre de t.f., $G$ est un objet de $C'$ où $k$ \uncertain{opère} (i.e.\ un
...
\page{39}
Soit \add{$k$ anneau \uncertain{commutatif}} $\mathbb{K}$ une catégorie \supplied{$k$-}additive (i.e.\ additive, munie
