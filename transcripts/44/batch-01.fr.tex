...
\textbf{Th. 1}\quad $N(\xi) \subset \mathrm{Alb}(S)$ n'est autr\supplied{e}
...
\begin{enumerate}
\item[1.] $(P, \Delta)$, où $P$ est un groupe abélien libre de rang fini, $\Delta$
...
\begin{enumerate}
\item[2.] $(P, P', \Delta, \Delta', \varphi)$, où \struck{\ill{}} $P, P'$ sont deux
