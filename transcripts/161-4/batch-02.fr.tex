...
%
% Revised 2026-09-23 (Opus 5.5): page 30's note no longer says the margin
% « renvoie par une flèche » to page 21 — an arrow cannot cross leaves. Checked
% on the facsimile (400-600 dpi): the margin's arrow runs from « Spec(A_f) ≃
% X_f (homéomorphisme) » down to the framed « 10') » item on the same leaf; the
% link to page 21's line b) is now stated as the editor's inference.
