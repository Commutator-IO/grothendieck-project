...
%  p. 16  Cor: « soit un faisceau » for « soit un schéma » (unflagged slip).
...
% stops). Dating: the pages support only « after EGA II » (margin p. 9) and a
% two-part summer course taught in English (p. 22); no course or year is named.
...
Une autre strate, plus ancienne peut-être, en tout cas d'un autre niveau, fait
la liste de ce qu'un cours plus avancé devrait contenir. La plus longue série
...
situe : on sait seulement qu'une marge de la page 9 renvoie à EGA II, et que
la page 22 prévoit un cours d'été en deux parties, enseigné en anglais. On ne
...
fidèle, et la page le note. En revanche la restriction des \emph{faisceaux} de
...
« schéma », que la transcription ne relève pas.}
...
pas de soi. Les flèches du croquis de gauche sont en pointillé, et celle du bas
porte deux pointes.} Cas particulier : l'intersection de deux sous-objets.
...
écrites au même moment.} La page 17 de notre dossier reprend exactement là : le
cas $E = \widehat{D}$, puis le cas général.
