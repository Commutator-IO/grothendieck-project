...
%
% Revised 2026-09-23 (Opus 5.5), page 21 re-read on the facsimile beside
% pp. 19-20 (batch 1, revised the same day to « Couples prétassés » and
% « Couples tassés », so the header and the p. 21 note below now agree with
% it): a note records that in both brackets of a), b) « pré » is written
% interlinearly above « tassé ».
%
% What the batch is.
...
\begin{itemize}
  ...
  \quad [$(f, f)$ prétassé]
  \note{dans ce crochet et dans celui de b), « pré » est écrit en interligne
  au-dessus de « tassé » : il avait d'abord écrit « tassé ».}
