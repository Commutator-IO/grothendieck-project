...
\note{au-dessus de « groupe », un mot interlinéaire relié par un trait, peut-être « facteur\ldots » ; la fin de la phrase, « objet gr.-pr. », est incertaine}
...
\begin{enumerate}
  ...
  \]
  compatible aux produits, i.e.\ \ldots\ commutativité du
\end{enumerate}
...
Mais dans le cas général, on ne peut oublier $V(A)$ \add{et ses opérations} au profit de $\check{A} = V(A)(k)$ \ldots
...
\]
où $n = \dim M$. Prouvons que c'est un mono. On a \struck{\ill{} \ill{}} \struck{$g \mapsto \varepsilon(f)$} \ldots\ Considérons \add{pour $\varphi \in M$} la fonction sur $G$
\[
...
\struck{De \ill{}} \struck{\ill{}} Donc on a une \uncertain{dualité} parfaite entre $V(M)$ et $W(M)$ \ldots
