...
\page{53}
1) $\mathcal{M}_{\xi_0}$ est \add{la structure d'}un groupe formel lisse
...
\]
on trouve un \add{contra-}foncteur $G\mapsto\mathbb{D}^*(G)$, et
\[
...
($\Rightarrow V$ de façon unique) et on obtient une \add{anti-}équivalence
...
\emph{Cas général} (\add{Anti-}équivalence entre la catégorie des $G$, et
celle des \add{$F$-}cristaux (i.e.\ $F$-$V$-cristaux) sur $S$ qui loc.\
