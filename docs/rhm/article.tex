...
\title{\Large Dater, reprendre, déplacer.\\ Ce que les notes de travail d'Alexandre Grothendieck\\ donnent à voir d'une pratique mathématique\\ (fonds de Montpellier, 1949--1991)}
...
6 & Lettre Tate (mai 66) (Cristaux) & 1966-[à partir de 1970]\\
...
13 & Groupe de Galois motivique & 1965\\
...
36 & SGA 7 (ma part) & [vers 1967-1973]\\
42 & Réseaux d'anneaux locaux & [années 1960-1970]\\
...
Le geste ne tient ni à une période ni à un support. Il est dans une lettre à Mumford écrite d'Alger le 1\textsuperscript{er} novembre 1965, qui s'ouvre sur un retrait --- \q{I have become aware that I have been a bit rash with the conjectures I told you about Hodge structures} (\lot{13}{1}{13}) --- et se clôt, en post-scriptum, sur \q{So I really do not know what to believe!} (\lot{13}{1}{18}). Il est sur un de ses propres tapuscrits (\cote{36}), où l'annonce dactylographiée \q{Je vais prouver la conjecture du nº~6} reçoit, face aux mots \q{vais prouver} entourés, une marge à l'encre : \q{non, pas tout à fait !} (\lot{36}{1}{17}). Il est encore, en 1983, dans les notes sur l'asphéricité qui accompagnent \emph{À la poursuite des champs} :

\begin{quote}
After a minute[']s thought, I feel very silly to find out that point a) is about trivial --- that I have been dragging for months the notion of a total[ly] W-aspheric category A, without taking the trouble to sit down and look whether it really depends on W [\dots] So let's clean it up in the long last ! (\lot{114}{1}{3})
\end{quote}

\noindent La correction n'efface pas ce qu'elle corrige : elle s'ajoute à côté, et la page garde les deux états.
...
La deuxième concerne la période qui suit 1970. Le récit courant, qui s'appuie en grande partie sur \emph{Récoltes et semailles}, fait de ces années celles d'un retrait. Les notes n'y contredisent pas le retrait institutionnel ; elles montrent une production mathématique continue et dense, menée en fils parallèles, datée au jour dans ses moments les plus intenses (l'hiver 1983--1984, juin 1986), et une activité de direction et d'échange --- Murre en 1967, Sính et Deligne en 1974, Bers en 1984 --- que la biographie mentionne sans pouvoir la montrer. Elles montrent aussi un enseignement qui cherche ses objets hors de la recherche en cours : l'annonce dactylographiée d'un cours de DEA de 1977--1978 à Montpellier part de ce qu'\q{il est étrange que l'icosaèdre, étudié depuis plus de deux mille ans dans des contextes et des optiques très divers, ne semble jamais avoir été étudié systématiquement du point de vue combinatoire}, et propose \q{une investigation commune sur ce thème, en partant de l'intuition combinatoire la plus naïve, exemplifiée sur des modèles en carton} (\lot{75}{2}{30}). Elles montrent aussi une œuvre qui ne se cite plus elle-même, et d'où les motifs, au moins dans le corpus transcrit, ont disparu. Les lectures qui voient dans les années 1949--1991 une vision d'un seul tenant (Zalamea 2025) trouvent dans les notes une trace de cette continuité, celle des objets et des programmes (section~6) ; elles y trouvent aussi une rupture qu'elles n'ont pas de raison de voir depuis l'imprimé, celle du renvoi à l'œuvre publiée.
...
\item Cruz Morales, John Alexander. 2024. « The Notion of Space in Grothendieck ». Dans Bharath Sriraman (éd.), \emph{Handbook of the History and Philosophy of Mathematical Practice}, 1865--1884. Cham : Springer. \url{https://doi.org/10.1007/978-3-031-40846-5_5}.
...
\item Krömer, Ralf. 2006. « La « machine de Grothendieck » se fonde-t-elle seulement sur des vocables métamathématiques ? Bourbaki et les catégories au cours des années cinquante ». \emph{Revue d'histoire des mathématiques} 12 (1) : 119--162. \url{https://doi.org/10.24033/rhm.38}.
...
\item McLarty, Colin. 2007. « The Rising Sea: Grothendieck on Simplicity and Generality ». Dans Jeremy J. Gray et Karen Hunger Parshall (éd.), \emph{Episodes in the History of Modern Algebra (1800--1950)}, 301--325. History of Mathematics 32. Providence : American Mathematical Society.
\item McLarty, Colin. 2025. « Grothendieck Did Not Believe in Universes, He Believed in Topos and Schemes ». Dans Panza, Struppa et Szczeciniarz 2025, 265--276.
...
\item Panza, Marco, Daniele C. Struppa et Jean-Jacques Szczeciniarz (éd.). 2025. \emph{The Mathematical and Philosophical Legacy of Alexander Grothendieck}. Chapman Mathematical Notes. Cham : Springer. \url{https://doi.org/10.1007/978-3-031-68934-5}.
...
\item Zalamea, Fernando. 2024. « Grothendieck: A Short Guide to His Mathematical and Philosophical Work (1949--1991) ». Dans Bharath Sriraman (éd.), \emph{Handbook of the History and Philosophy of Mathematical Practice}, 1257--1296. Cham : Springer. \url{https://doi.org/10.1007/978-3-031-40846-5_27}.
\item Zalamea, Fernando. 2025. « Grothendieck's 40 Main Years (1949--1991): A Unitary Vision Through the TSK Models (Topos of Sheaves over Kripke Models) ». Dans Panza, Struppa et Szczeciniarz 2025, 1--43.
\end{list}
